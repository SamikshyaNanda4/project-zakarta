...
import { Building2, Home, IndianRupee, Loader2, CheckCircle2 } from "lucide-react";
      ...
      <Form {...form}>
        <form noValidate className="space-y-3">
          ...
          <Section3Pricing
            ...
            onSave={() => saveSection(2, section3Fields)}
            isSell={isSell}
          ...
          {/* Section 5 — Additional Info (Sell only) */}
          {isSell && (
            <Section5Additional
              form={form}
