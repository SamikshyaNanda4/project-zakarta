...
import { FormDescription } from "@repo/ui/components/ui/form";
import {
  WHO_SHOWS,
  CURRENT_SELL_STATUS,
...
import { CheckToggle } from "../formComponents/ToggleButton";
...
export function Section4Amenities({
  ...
  const amenityList = isSell ? SELL_AMENITIES : RENT_AMENITIES;
  ...
  return (
    <SectionCard
      ...
      onSave={onSave}
    >
      {/* Bathrooms / Kitchens or Balcony / Who Shows */}
      ...
      {/* Current Status / Condition + Water Supply */}
      {isSell ? (
        <FormField
          control={form.control}
          name="currentStatus"
      ...
      {/* Rent-only: Direction Description */}
      {!isSell && (
        <FormField
          control={form.control}
